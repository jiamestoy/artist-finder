    ...
    return (
        <Link to={`/artist/${artist._id}`}>
            <div className="artist-card">
                <img className='artwork-img' src={`/imgs/${artist.portfolio ? "portfolio/" + artist.username + "/" + artist.portfolio[0] : 'service_placeholder.jpg'}`} alt={`Trabajo de ${artist.username}`} />
